  ...
  <div class="layout-root-blue">
    <aside class="sidebar-blue">
      ...
      >
        ...
        <el-menu-item index="/student/class-courses">
        ...
        <div class="header-left-blue">
          <el-breadcrumb separator="/" class="breadcrumb-blue styled-breadcrumb-multi">
            ...
            <el-breadcrumb-item>
              ...
              <el-icon v-else-if="getCurrentPageTitle() === '我的课程'" style="vertical-align: middle; margin-right: 2px;"><Reading /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '班级课程'" style="vertical-align: middle; margin-right: 2px;"><School /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '我的成绩'" style="vertical-align: middle; margin-right: 2px;"><Document /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '个人信息'" style="vertical-align: middle; margin-right: 2px;"><User /></el-icon>
