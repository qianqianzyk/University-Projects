        ...
        <div class="header-left-blue">
          <el-breadcrumb separator="/" class="breadcrumb-blue styled-breadcrumb-multi">
            ...
            <el-breadcrumb-item>
              ...
              <el-icon v-else-if="getCurrentPageTitle() === '教师管理'" style="vertical-align: middle; margin-right: 2px;"><Avatar /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '班级管理'" style="vertical-align: middle; margin-right: 2px;"><School /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '课程管理'" style="vertical-align: middle; margin-right: 2px;"><Reading /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '部门管理'" style="vertical-align: middle; margin-right: 2px;"><OfficeBuilding /></el-icon>
              <el-icon v-else-if="getCurrentPageTitle() === '授课管理'" style="vertical-align: middle; margin-right: 2px;"><Calendar /></el-icon>
        ...
        <div class="header-right-blue">
          <el-dropdown @command="handleCommand">
            <span class="user-info-blue">
              <el-icon class="user-avatar-blue"><Avatar /></el-icon>
